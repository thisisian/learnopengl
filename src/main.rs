...
fn main() {
    ...
    let texture = unsafe { Texture::new("container2.png").unwrap() };
    let texture_specular = unsafe { Texture::new("container2_specular.png").unwrap() };
    ...
    'running: loop {
        ...
        unsafe {
            ...
            box_shader_program
                .set_uniform_i32("material.diffuse", 0)
                .unwrap();
            box_shader_program
                .set_uniform_i32("material.specular", 1)
                .unwrap();
            box_shader_program
